...
Scheme
{
	...
	BaseSettings
	{
		...
		INFRAOptionsCycleableButton.OptionLabelDefaultFont			"MenuLarge"
		INFRAOptionsCycleableButton.OptionLabelArmedFont			"MenuLarge"
		INFRAOptionsCycleableButton.OptionLabelDisabledFont			"MenuLargeAdditive"
		INFRAOptionsCycleableButton.DescriptionLabelDefaultFont		"MenuLargeLight"
		INFRAOptionsCycleableButton.DescriptionLabelArmedFont		"MenuLargeLight"
		INFRAOptionsCycleableButton.DescriptionLabelDisabledFont	"MenuLargeLightAdditive"
		...
		INFRAOptionsSlider.TrackWidthRatio							"2"
		INFRAOptionsSlider.SliderInset								"8"
		INFRAOptionsSlider.ThumbWidth								"1"
		INFRAOptionsSlider.TrackHeight								"1"
		INFRAOptionsSlider.NobHeight								"16"
		...
		INFRAMenuItemList.ItemHeight								"40"
	}
